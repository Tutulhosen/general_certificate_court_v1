    ...
    <div class="row">
        <div class="col-md-6">
            <table class="table table-striped border">
               ...
               <tbody>
                   <tr>
                     <th scope="row">দাবিকৃত অর্থের পরিমাণ (আসল)</th>
                     <td >{{ en2bn($appeal->running_case_required_amount) ?? '-'}} টাকা</td>
                  </tr>
                  <tr>
                     <th scope="row">দাবিকৃত অর্থের পরিমাণ (কথায়)</th>
                     <td >{{ $appeal->running_case_required_amount_text ?? '-'}} টাকা</td>
                  </tr>
                  <tr>
                     <th scope="row">মোট সুদের পরিমাণ</th>
                     <td >{{ en2bn($appeal->running_case_interest) ?? '-'}} টাকা</td>
                  </tr>
                  <tr>
                     <th scope="row">মোট সুদের পরিমাণ (কথায়)</th>
                     <td >{{ $appeal->running_case_interest_text ?? '-'}} টাকা</td>
                  </tr>
                  <tr>
                     <th scope="row">মোট অর্থের পরিমাণ (সুদসহ)</th>
                     <td >{{ en2bn($appeal->running_case_total_amount) ?? '-'}} টাকা</td>
                  </tr>
                 <tr>
      ...
      <div class="col-md-12">
        ...
        <table class="table table-striped border">
         <thead>
             <th class="h3" scope="col" colspan="2">কোর্ট ফি সংযুক্তি</th>
         </thead>
        <tbody>
           <tr>
              <td>
                 @if($appeal->running_case_court_fee_attached)

                       <div class="form-group mb-2" id="deleteFile{{ $appeal->id }}">
                           <div class="input-group">
                               <div class="input-group-prepend">
                                  
                               </div>
                               
                               <input readonly type="text" class="form-control" value="কোর্ট ফি" />
                               <div class="input-group-append">
                                   <a href="{{ asset("running_case_court_fee_attached/" . $appeal->running_case_court_fee_attached) }}" target="_blank" class="btn btn-sm btn-success font-size-h5 float-left">
                                       <i class="fa fas fa-file-pdf"></i>
                                       <b>দেখুন</b>
                                    </a>
            ...
            <tr>
               <td>
                  @if($hajira)
                        ...
                        <div class="form-group mb-2" id="deleteFile{{ $hajira->id }}">
                              <div class="input-group">
                                 <div class="input-group-prepend">
                                    
                                 </div>
                                 
                                 <input readonly type="text" class="form-control" value="{{ $hajira->file_category ?? '' }}" />
                                 <div class="input-group-append">
                                    <a href="{{ asset($hajira->file_path . $hajira->file_name) }}" target="_blank" class="btn btn-sm btn-success font-size-h5 float-left">
                                          <i class="fa fas fa-file-pdf"></i>
                                          <b>দেখুন</b>
                                       </a>
      ...
      <table class="table table-striped border">
         <thead>
            <th class="h3" scope="col" colspan="2">অন্যান্য সংযুক্তি</th>
         </thead>
         <tbody>
            <tr>
               <td>
                  @forelse ($others as $key => $row)
                        <div class="form-group mb-2" id="deleteFile{{ $row->id }}">
                              <div class="input-group">
                                 <div class="input-group-prepend">
                                    <button class="btn bg-success-o-75" type="button">{{ en2bn(++$key) . ' - নম্বর :' }}</button>
