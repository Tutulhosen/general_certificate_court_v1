                                        ...
                                        @if ($runningcommandList)
                                            <div class="form-group mb-2" id="deleteFile{{ $runningcommandList->id }}">
                                                <div class="input-group">
                                                    ...
                                                    <input readonly type="text" class="form-control"
                                                        value="{{ $runningcommandList->file_category ?? '' }}" />
                                                    <div class="input-group-append">
                                                        <a href="{{ asset($runningcommandList->file_path . $runningcommandList->file_name) }}"
                                                            target="_blank"
                                                            class="btn btn-sm btn-success font-size-h5 float-left">
                                                            <i class="fa fas fa-file-pdf"></i>
                                                            <b>দেখুন</b>
                                        ...
                                        @if ($attendance_list)
                                            <div class="form-group mb-2" id="deleteFile{{ $attendance_list->id }}">
                                                <div class="input-group">
                                                    ...
                                                    <input readonly type="text" class="form-control"
                                                        value="{{ $attendance_list->file_category ?? '' }}" />
                                                    <div class="input-group-append">
                                                        <a href="{{ asset($attendance_list->file_path . $attendance_list->file_name) }}"
                                                            target="_blank"
                                                            class="btn btn-sm btn-success font-size-h5 float-left">
                                                            <i class="fa fas fa-file-pdf"></i>
                                                            <b>দেখুন</b>
