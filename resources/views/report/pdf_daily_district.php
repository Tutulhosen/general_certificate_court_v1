...
<head>
    ...
    <style type="text/css">
        ...
        .table-hover.table-bordered.report {
            border-collapse: collapse; /* Ensures borders don't double */
            border: 1px solid black; /* Makes the table's border bold */
        }
...
<body>
	<div class="priview-body">
        ...
        <div class="row d-flex justify-content-center align-items-center" style="height: 100vh;">
            <div class="col-12 text-center" style="border: 0px solid red;">
                <p class="text-center" style="margin-top: -10px;">
                    <span style="font-size:25px;font-weight: bold;">গণপ্রজাতন্ত্রী বাংলাদেশ সরকার</span><br> 
                    <span style="font-size:18px;">জেনারেল সার্টিফিকেট শাখা</span>
                </p>
                <div style="font-size:18px; margin-top:-10px"><u><?= $page_title ?></u></div>
                <p class="text-center" style="font-size:18; margin-top:10px">বিভাগঃ <?=$div_name?>
                <p class="text-center" style="font-size:18px;">তারিখঃ <?= en2bn($today) ?></p>
            </div>
        </div>
